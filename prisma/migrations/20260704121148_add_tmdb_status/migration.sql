...
CREATE TABLE "new_ShowTracking" (
    ...
    "tmdbStatus" TEXT NOT NULL DEFAULT '',
...
INSERT INTO "new_ShowTracking" ("addedAt", "id", "posterPath", "showName", "status", "tmdbShowId", "totalEpisodes", "updatedAt", "userId", "watchedCount") SELECT "addedAt", "id", "posterPath", "showName", "status", "tmdbShowId", "totalEpisodes", "updatedAt", "userId", "watchedCount" FROM "ShowTracking";
